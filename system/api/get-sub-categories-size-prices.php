...
if (isset($_GET['sub_category_id']) && $_GET['lang'] != '') {
    ...
    $result = mysql_query("SELECT * FROM `sub_categories_size_prices` WHERE `sub_category_id`='$sub_category_id'") or die(mysql_error());
...
// check for empty result
    if (mysql_num_rows($result) > 0) {
        ...
        while ($row = mysql_fetch_array($result)) {
            ...
            $product["sub_category_size_price"] =$row["sub_category_size_price"];
