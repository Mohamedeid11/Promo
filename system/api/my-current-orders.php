...
if (isset($_GET['client_id']) && $_GET['lang'] != '') {
    ...
    $result = mysql_query("SELECT * FROM `orders` WHERE `client_id`='$client_id' and ((`order_follow`!=3 and `order_follow`!=0 ) or `order_status`=0) and del=0 ORDER BY `order_id` DESC") or die(mysql_error());
