                            ...
                            <table class="table table-striped" id="">
                                ...
                                <?php foreach ($allData as $key => $one) {
                                    ...
                                    <tr class="gradeX <?php echo $one['parent_category_id']; ?>">
                                        <td><?php echo $key; ?></td>
                                        <td><a href="sub_service_view.php?parent_category_id=<?php echo $one['parent_category_id']; ?>"><?php echo $one['parent_category_name']; ?></a></td>
                                        <td><a href="sub_service_view.php?parent_category_id=<?php echo $one['parent_category_id']; ?>"><?php echo $one['parent_category_name_ar']; ?></a></td>
                                        ...
                                        <td class="actions">
                                            <a href="services_edit.php?catId=<?php echo $one['parent_category_id']; ?>" class=""><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <td class="actions">
                                            <a href="services_details.php?catId=<?php echo $one['parent_category_id']; ?>" class="on-default"><i class="fa fa-eye"></i></a>
                                        </td>
                                        <td class="actions">
