            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="testimonial_view.php">TestiMonial </a></li>
                            ...
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="testimonial_edit.php?sliderID=<?= $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/testimonial_functions.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
