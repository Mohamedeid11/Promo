            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> Edited Orders Report</h4>
                                <ol class="breadcrumb">
                                    <li><a href="edited_report.php">   Edited Orders Report</a></li>
                                    <li class="active">View  Edited Orders Report   </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form method="post" action="print_edited_report.php" enctype="multipart/form-data" target="_blank" data-parsley-validate>
