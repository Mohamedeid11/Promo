                    ...
                    <div class="panel-body">
                        <div class="">
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                $query = $con->query("SELECT * FROM `our_team` ORDER BY `id` ASC");
                                $x = 1;
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="our_team_edit.php?sliderID=<?= $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/team_functions.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
