            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> Report Deleted Orders</h4>
                                <ol class="breadcrumb">
                                    <li><a href="deleted_report.php">Report Deleted Orders</a></li>
                                    <li class="active">View Report Deleted Orders</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form method="post" action="print_deleted_report.php" enctype="multipart/form-data" target="_blank" data-parsley-validate>
