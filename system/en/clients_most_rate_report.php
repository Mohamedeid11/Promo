            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> Most Requested Sub Categories Report </h4>
                                <ol class="breadcrumb">
                                    <li><a href="average_cost_report.php">Most Requested Sub Categories Report</a></li>
                                    <li class="active">Most Requested Sub Categories Report</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b> Advanced Search </b></h4>
                                    <p class="text-muted font-13 m-b-30"></p>  
                                    <form method="post" action="print_average_cost_report.php" enctype="multipart/form-data" target="_blank" data-parsley-validate>
